"""
Обновленные настройки Django для task_3 с интеграцией Djoser
Этот файл дополняет settings.py из task_1
"""
...
DJOSER = {
    ...
    'SEND_ACTIVATION_EMAIL': False,  # Отключаем для упрощения, можно включить в продакшене
    'SERIALIZERS': {
